package com.aqsoft.translator.talkingdog.prank.simulator.translator
...
import com.aqsoft.translator.talkingdog.prank.simulator.DialogUtil
import com.aqsoft.translator.talkingdog.prank.simulator.R
import com.aqsoft.translator.talkingdog.prank.simulator.databinding.FragmentTranslatorBinding
        ...
        binding?.ivVoice?.setOnClickListener {
            ...
            if (!isRecording) {
                ...
                try {
                    ...
                    Toast.makeText(
                        requireContext(),
                        "Vui lòng cấp quyền sử dụng Microphone",
                        Toast.LENGTH_SHORT
                    ).show()
                }
            } else {
