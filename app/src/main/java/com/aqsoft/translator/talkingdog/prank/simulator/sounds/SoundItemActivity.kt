...
import com.aqsoft.translator.talkingdog.prank.simulator.databinding.ActivitySoundItemBinding
import com.aqsoft.translator.talkingdog.prank.simulator.language.KeyValue
...
//            stopPlay()
        ...
        years.add(KeyValue("1", "Tắt"))
        years.add(KeyValue("2", "15 giây"))
        years.add(KeyValue("3", "30 giây"))
        years.add(KeyValue("4", "45 giây"))
        years.add(KeyValue("5", "1 " + "Phút"))
        years.add(KeyValue("6", "2 " + "Phút"))
        years.add(KeyValue("7", "5 " + "Phút"))
